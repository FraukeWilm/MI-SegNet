...
from MI_SegNet import Mine_Conv, Seg_encoder_LM,Seg_decoder_LM,Recon_var_encoder_LM, Recon_decoder_LM
...
class VarModule(pl.LightningModule):
    def __init__(self, cfg, device, **kwargs):
        ...
        self.rec_encoder = Recon_var_encoder_LM(cfg.data.patch_size, in_channels=cfg.model.input_channel, init_features=16).to(device)
    ...
    def update_Rec(self, inputs, gt, train):
        ...
        z_d, kl = self.rec_encoder(inputs)
    ...
    def update_Rec_Adv(self, inputs_1, inputs_2, inputs_12, train):
        ...
        z_d, kl = self.rec_encoder(inputs_1)
